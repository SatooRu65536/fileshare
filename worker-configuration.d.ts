// Generated by Wrangler by running `wrangler types` (hash: 8dcfd028f79d8112bf34200655090770)
// Runtime types generated with workerd@1.20250310.0 2025-03-14 
interface Env {
	BASIC_AUTH_USERNAME: string;
	BASIC_AUTH_PASSWORD: string;
	R2_TOKEN_VALUE: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY_ID: string;
